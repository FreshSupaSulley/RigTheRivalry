...
- Implement accounts - that's the easiest way to stop all of this. If you force people to login, you can easily rate limit based on users and not per connection _and_ filter out people who abuse the site. Without accounts, you open yourself up to degenerate distributed attacks like this.
